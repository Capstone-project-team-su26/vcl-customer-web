...
const ROUTES = [
  {
    ...
    methods: [
      { id: "road", label: "Đường bộ", rate: 32000 },
      { id: "air", label: "Hàng không", rate: 98000 },
    ],
  },
  {
    id: "japan",
    ...
    methods: [
      { id: "air", label: "Hàng không", rate: 145000 },
      { id: "sea", label: "Đường biển", rate: 78000 },
    ],
  },
  {
    id: "korea",
    ...
    methods: [
      { id: "air", label: "Hàng không", rate: 125000 },
      { id: "sea", label: "Đường biển", rate: 72000 },
    ],
  },
  {
    id: "western",
    ...
    methods: [
      { id: "air", label: "Hàng không", rate: 225000 },
      { id: "sea", label: "Đường biển", rate: 118000 },
    ],
  },
];
...
const FAQS = [
  ...
  },
  {
    ...
    answer:
      "Khối lượng tính cước thường là giá trị lớn hơn giữa khối lượng thực tế và khối lượng quy đổi theo kích thước. Khối lượng quy đổi = Dài × Rộng × Cao (cm) chia cho hệ số quy đổi thể tích trong bảng giá hiện hành.",
  },
  {
...
const ConsignmentService = () => {
  ...
  const calculation = useMemo(() => {
    ...
    const volumetricWeightPerPackage =
      hasFullDimensions && volumetricDivisor
