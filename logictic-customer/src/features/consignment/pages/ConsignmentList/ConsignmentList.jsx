...
const PENDING_REVIEW_STATUS = ORDER_STATUS.PENDING_REVIEW;

/* Mã đơn được chuẩn hóa về mã đích (mã cũ như PENDING → PENDING_REVIEW). */
...
const ConsignmentList = () => {
  ...
  /* Nhãn trạng thái đơn lấy từ module dùng chung. */
  const getStatusLabel = (status) => getOrderStatusLabel(status);
